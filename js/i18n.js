...
(function () {
  ...
  var dict = {
    es: {
      ...
      /* hero */
      'hero.eyebrow': 'PHARMA · HEALTHCARE · VISUAL COMUNICATION · DIGITAL MARKETING',
      ...
      'svc.b.title': 'Materiales y sistemas corporativos',
      ...
      'svc.e.title': 'Estrategia omnicanal',
      'svc.e.alt': 'Estrategia omnicanal para healthcare',
      'svc.e.lead': 'Conectamos todos los canales para crear una experiencia coherente para profesionales sanitarios y pacientes.',
      'svc.e.li1': 'Mapeo de audiencias y recorridos de comunicación',
      'svc.e.li2': 'Campañas coordinadas digitales y presenciales',
      'svc.e.li3': 'Contenidos adaptados a cada canal y etapa',
      'svc.e.li4': 'Puntos de contacto por email, web, redes sociales y equipos comerciales',
      'svc.e.li5': 'Medición del rendimiento y optimización continua',
      'svc.e.thesis': 'Convertimos interacciones aisladas en una conversación de marca coherente.',
      'svc.f.title': 'Materiales y módulos formativos',
      'svc.f.alt': 'Materiales y módulos de formación healthcare',
      'svc.f.lead': 'Hacemos que la información sanitaria compleja sea clara, atractiva y práctica.',
      'svc.f.li1': 'Materiales de formación científica y de producto',
      'svc.f.li2': 'Módulos interactivos de e-learning',
      'svc.f.li3': 'Presentaciones y recursos para equipos comerciales',
      'svc.f.li4': 'Programas formativos para profesionales sanitarios',
      'svc.f.li5': 'Evaluaciones y herramientas para reforzar el aprendizaje',
      'svc.f.thesis': 'Transformamos el conocimiento en formación que los equipos pueden aplicar con confianza.',
      ...
      'form.privacidad': 'He leído y acepto la <a href="privacidad.html" target="_blank" rel="noopener">Política de Privacidad</a>.',
      'form.marketing': 'Sí, quiero recibir comunicaciones comerciales y novedades de VitalEdge Lab por email.',
    ...
    en: {
      ...
      'svc.b.title': 'Corporate materials and systems',
      ...
      'svc.e.title': 'Omnichannel strategy',
      'svc.e.alt': 'Omnichannel strategy for healthcare',
      'svc.e.lead': 'We connect every channel to create a consistent experience for healthcare professionals and patients.',
      'svc.e.li1': 'Audience mapping and communication journeys',
      'svc.e.li2': 'Coordinated digital and in-person campaigns',
      'svc.e.li3': 'Content tailored to each channel and stage',
      'svc.e.li4': 'Email, web, social media and sales force touchpoints',
      'svc.e.li5': 'Performance measurement and ongoing optimisation',
      'svc.e.thesis': 'We turn separate interactions into one coherent brand conversation.',
      'svc.f.title': 'Training materials and modules',
      'svc.f.alt': 'Healthcare training materials and modules',
      'svc.f.lead': 'We make complex healthcare information clear, engaging and practical to use.',
      'svc.f.li1': 'Scientific and product training materials',
      'svc.f.li2': 'Interactive e-learning modules',
      'svc.f.li3': 'Presentations and resources for sales teams',
      'svc.f.li4': 'Training programmes for healthcare professionals',
      'svc.f.li5': 'Assessments and tools to reinforce learning',
      'svc.f.thesis': 'We transform knowledge into training that teams can apply with confidence.',
      ...
      'form.privacidad': 'I have read and accept the <a href="privacidad.html" target="_blank" rel="noopener">Privacy Policy</a>.',
      'form.marketing': 'Yes, I want to receive commercial communications and news from VitalEdge Lab by email.',
    ...
    ca: {
      ...
      'svc.b.title': 'Materials i sistemes corporatius',
      ...
      'svc.e.title': 'Estratègia omnicanal',
      'svc.e.alt': 'Estratègia omnicanal per a healthcare',
      'svc.e.lead': 'Connectem tots els canals per crear una experiència coherent per a professionals sanitaris i pacients.',
      'svc.e.li1': 'Mapatge d’audiències i recorreguts de comunicació',
      'svc.e.li2': 'Campanyes digitals i presencials coordinades',
      'svc.e.li3': 'Continguts adaptats a cada canal i etapa',
      'svc.e.li4': 'Punts de contacte per email, web, xarxes socials i equips comercials',
      'svc.e.li5': 'Mesurament del rendiment i optimització contínua',
      'svc.e.thesis': 'Convertim interaccions aïllades en una conversa de marca coherent.',
      'svc.f.title': 'Materials i mòduls formatius',
      'svc.f.alt': 'Materials i mòduls de formació healthcare',
      'svc.f.lead': 'Fem que la informació sanitària complexa sigui clara, atractiva i pràctica.',
      'svc.f.li1': 'Materials de formació científica i de producte',
      'svc.f.li2': 'Mòduls interactius d’e-learning',
      'svc.f.li3': 'Presentacions i recursos per a equips comercials',
      'svc.f.li4': 'Programes formatius per a professionals sanitaris',
      'svc.f.li5': 'Avaluacions i eines per reforçar l’aprenentatge',
      'svc.f.thesis': 'Transformem el coneixement en formació que els equips poden aplicar amb confiança.',
      ...
      'form.privacidad': 'He llegit i accepto la <a href="privacidad.html" target="_blank" rel="noopener">Política de Privacitat</a>.',
      'form.marketing': 'Sí, vull rebre comunicacions comercials i novetats de VitalEdge Lab per correu electrònic.',
    ...
    fr: {
      ...
      'svc.b.title': 'Supports et systèmes corporate',
      ...
      'svc.e.title': 'Stratégie omnicanale',
      'svc.e.alt': 'Stratégie omnicanale pour le healthcare',
      'svc.e.lead': 'Nous relions chaque canal pour créer une expérience cohérente pour les professionnels de santé et les patients.',
      'svc.e.li1': 'Cartographie des audiences et des parcours de communication',
      'svc.e.li2': 'Campagnes numériques et en présentiel coordonnées',
      'svc.e.li3': 'Contenus adaptés à chaque canal et à chaque étape',
      'svc.e.li4': 'Points de contact par email, web, réseaux sociaux et équipes commerciales',
      'svc.e.li5': 'Mesure des performances et optimisation continue',
      'svc.e.thesis': 'Nous transformons des interactions séparées en une conversation de marque cohérente.',
      'svc.f.title': 'Supports et modules de formation',
      'svc.f.alt': 'Supports et modules de formation healthcare',
      'svc.f.lead': 'Nous rendons les informations de santé complexes claires, engageantes et faciles à mettre en pratique.',
      'svc.f.li1': 'Supports de formation scientifique et produit',
      'svc.f.li2': 'Modules interactifs d’e-learning',
      'svc.f.li3': 'Présentations et ressources pour les équipes commerciales',
      'svc.f.li4': 'Programmes de formation pour les professionnels de santé',
      'svc.f.li5': 'Évaluations et outils pour renforcer l’apprentissage',
      'svc.f.thesis': 'Nous transformons le savoir en formations que les équipes peuvent appliquer en toute confiance.',
      ...
      'form.privacidad': 'J\'ai lu et j\'accepte la <a href="privacidad.html" target="_blank" rel="noopener">Politique de Confidentialité</a>.',
      'form.marketing': 'Oui, je souhaite recevoir des communications commerciales et des actualités de VitalEdge Lab par e-mail.',
